<?php
    ...
    $query_two = "SELECT * FROM student_attendance_creation_table WHERE term = '$term' AND session = '$session' AND class = '$class'";
...
<body>
    ...
    <div id="form_container">
        ...
        <div id="header">
            <h2><?php echo $class ?> student daily attendance</h2>
        </div>
        ...
        $(document).ready(function(){
            ...
            $('#submit').click(function(event){
                ...
                $.ajax({
                    ...
                    url: 'action_php/student_daily_attendance_form_action.php',
                    data: $('#form').serialize(),
                    method: 'POST',
                    dataType: 'text',
