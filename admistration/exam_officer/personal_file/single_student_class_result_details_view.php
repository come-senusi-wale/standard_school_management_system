<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!preg_match($session_reg, $session)) {
            ...
            header("location: single_student_class_result_form.php?fail=$out");
            ...
            if (empty($class) || empty($addmission_number)) {
                ...
                if ($num < 1) {
                    ...
                    if ($num_three > 0) {
                        ...
                        $highest_avg = round(($highest_total/14), 2);
                    }
                    ...
                    if ($num_four > 0) {
                        ...
                        $lowest_avg = round(($lowest_total/14), 2);
                    }
                        ...
                        while ($row_two = mysqli_fetch_array($query_run_two)) {
                            ...
                            if ($category == 'senior') {
                                ...
                                <div id="body_content">
                                    ...
                                    <div class="subject small-border body"><?php echo $to_gov?></div>
                             ...
                             <?php  
                                ...
                                <div id="body_content">
                                    ...
                                    <div class="subject small-border body"><?php echo $to_fre?></div>
                                    <div class="subject small-border body"><?php echo $to_mat?></div>
