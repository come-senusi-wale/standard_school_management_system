<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!preg_match($session_reg, $session)) {
            ...
            header("location: pupil_class_ca_detail_form.php?fail=$out");

        }else{

            if (empty($class)) {
                $out = 'please select pupils category';
                header("location: pupil_class_ca_detail_form.php?fail=$out");
                ...
                if ($num < 1) {
                    ...
                    if ($num_two < 1) {
                        ...
                        $out = 'no ca records for this class';
                        header("location: pupil_class_ca_detail_form.php?fail=$out");
                        exit();
                    }
...
<head>
    ...
    <title>pupil ca details form</title>
...
<body>
    ...
    <section id="reg_section">
        <div class="reg_header">
            <h2><?php echo $class.' '.$term.' term '.$ca.' entrance detail' ?></h2>
                    ...
                    <div id="header">
                        ...
                        <?php
                            ...
                            <div id="heeder_content">
                                ...
                                <div class="subject complete-border head" class="action_btn" style="width: 65px;"><p>edit</p></div>
                                <div class="subject complete-border head" class="action_btn" style="width: 85px;"><p>delete</p></div>
                        ...
                        while ($row_two = mysqli_fetch_array($query_run_two)) {
                            ...
                            if($category == 'p_nur') {
                                ...
                                <div id="body_content">
                                    ...
                                    <div class="subject small-border body" style="width: 60px; ">
                                            ...
                                            <a href="pupil_ca_edit_form.php?addmission_number=<?php echo $addmission_number ?>&amp;term=<?php echo $term ?>&amp;class=<?php echo $class ?>&amp;ca=<?php echo $ca ?>&amp;session=<?php echo $session ?>&amp;category=<?php echo $category ?>" id="" class="edit_btn" style="background: blue;">edit</a>
                                    ...
                                    <div class="subject small-border body" style="width: 80px; ">
                                            ...
                                            <button id="delete_btn" style="background: red;" data-addmission_number="<?php echo $addmission_number ?>" data-term="<?php echo $term ?>"  data-ca="<?php echo $ca ?>" data-session="<?php echo $session ?>" data-class="<?php echo $class ?>" data-category="<?php echo $category ?>" data-counter="<?php echo $counter ?>"  class="delete_btn termmnate_btn">delete</button>
                            ...
                            <?php
                                ...
                                <div id="body_content">
                                    ...
                                    <div class="subject small-border body" style="width: 55px; ">
                                        
                                            <a href="pupil_ca_edit_form.php?addmission_number=<?php echo $addmission_number ?>&amp;term=<?php echo $term ?>&amp;class=<?php echo $class ?>&amp;ca=<?php echo $ca ?>&amp;session=<?php echo $session ?>&amp;category=<?php echo $category ?>" id="" class="edit_btn" style="background: blue;">edit</a>
                                    
                                    </div>

                                    <div class="subject small-border body" style="width: 75px; ">
            ...
            <script>
                $(document).ready(function(){
                    ...
                    $('.termmnate_btn').click(function(event){
                        ...
                        var ca = event.target.getAttribute('data-ca');
                        ...
                        if (confirm('do you want to delete this ca records')) {
                            ...
                            $.ajax({
                                ...
                                data: {action: 'delete pupil ca record from view detail', term: term, ca: ca, classe: classe, session: session, addmission_number: addmission_number},
                                method: 'POST',
                                dataType: 'text',
                                beforeSend: function(){
