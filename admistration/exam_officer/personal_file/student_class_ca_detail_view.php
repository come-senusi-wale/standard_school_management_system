<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!preg_match($session_reg, $session)) {
            ...
            header("location: student_class_ca_detail_form.php?fail=$out");
                            ...
                            if($category == 'senior') {
                                ...
                                <div id="body_content">
                                    ...
                                    <div class="subject small-border body" style="width: 60px; ">
                                            ...
                                            <a href="student_ca_edit_form.php?addmission_number=<?php echo $addmission_number ?>&amp;term=<?php echo $term ?>&amp;class=<?php echo $class ?>&amp;ca=<?php echo $ca ?>&amp;session=<?php echo $session ?>&amp;category=<?php echo $category ?>" id="" class="edit_btn" style="background: blue;">edit</a>
                    ...
                    $('.termmnate_btn').click(function(event){
                        ...
                        if (confirm('do you want to delete this ca records')) {
                            ...
                            $.ajax({
                                ...
                                data: {action: 'delete student record from view detail', term: term, ca: ca, classe: classe, session: session, addmission_number: addmission_number},
                                method: 'POST',
                                dataType: 'text',
                                beforeSend: function(){
