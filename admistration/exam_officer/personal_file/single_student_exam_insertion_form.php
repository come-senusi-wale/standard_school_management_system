<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!preg_match($session_reg, $session)) {
            ...
            header("location: single_student_exam_form.php?fail=$out");
...
<head>
    ...
    <title>single student exam insertion form</title>
            ...
            <script>
                $(document).ready(function(){
                    ...
                    $('#ca_form').submit(function(event){
                        ...
                        $.ajax({
                            url: 'action_php/single_student_exam_insertion_form_action.php',
                            method: 'POST',
