            ...
            if ($num > 0) {
                ...
                if ($category == 'junior') {
                    ...
                    foreach ($addmission_numbers as $addmission_number) {
                        ...
                        $query_two = "INSERT INTO $class_exam_table(name, addmission_num, session, term, mat, eng, b_s, b_t, sos, civ, agri, h_e, rel, kni, com, bus, phe, cca, gam, a_c, lan, woo, f_mat, f_eng, f_b_s, f_b_t, f_sos, f_civ, f_agri, f_h_e, f_rel, f_kni, f_com, f_bus, f_phe, f_cca, f_gam, f_a_c, f_lan, f_woo, s_mat, s_eng, s_b_s, s_b_t, s_sos, s_civ, s_agri, s_h_e, s_rel, s_kni, s_com, s_bus, s_phe, s_cca, s_gam, s_a_c, s_lan, s_woo, t_mat, t_eng, t_b_s, t_b_t, t_sos, t_civ, t_agri, t_h_e, t_rel, t_kni, t_com, t_bus, t_phe, t_cca, t_gam, t_a_c, t_lan, t_woo, to_mat, to_eng, to_b_s, to_b_t, to_sos, to_civ, to_agri, to_h_e, to_rel, to_kni, to_com, to_bus, to_phe, to_cca, to_gam, to_a_c, to_lan, to_woo, total_score, status) VALUES('$name', '$addmission_number', '$session', '$term', '$mat', '$eng', '$b_s', '$b_t', '$sos', '$civ', '$agri', '$h_e', '$rel', '$kni', '$com', '$bus', '$phe', '$cca', '$gam', '$a_c', '$lan', '$woo', '$f_mat', '$f_eng', '$f_b_s', '$f_b_t', '$f_sos', '$f_civ', '$f_agri', '$f_h_e', '$f_rel', '$f_kni', '$f_com', '$f_bus', '$f_phe', '$f_cca', '$f_gam', '$f_a_c', '$f_lan', '$f_woo', '$s_mat', '$s_eng', '$s_b_s', '$s_b_t', '$s_sos', '$s_civ', '$s_agri', '$s_h_e', '$s_rel', '$s_kni', '$s_com', '$s_bus', '$s_phe', '$s_cca', '$s_gam', '$s_a_c', '$s_lan', '$s_woo', '$t_mat', '$t_eng', '$t_b_s', '$t_b_t', '$t_sos', '$t_civ', '$t_agri', '$t_h_e', '$t_rel', '$t_kni', '$t_com', '$t_bus', '$t_phe', '$t_cca', '$t_gam', '$t_a_c', '$t_lan', '$t_woo', '$to_mat', '$to_eng', '$to_b_s', '$to_b_t', '$to_sos', '$to_civ', '$to_agri', '$to_h_e', '$to_rel', '$to_kni', '$to_com', '$to_bus', '$to_phe', '$to_cca', '$to_gam', '$to_a_c', '$to_lan', '$to_woo', '$total_score', 'not approved') ";
                    ...
                    foreach ($addmission_numbers as $addmission_number) {
                        ...
                        $query_two = "INSERT INTO $class_exam_table(name, addmission_num, session, term, mat, eng, phy, che, bio, agri, ent, f_m, eco, com, civ, geo, rel, f_mat, f_eng, f_phy, f_che, f_bio, f_agri, f_ent, f_f_m, f_eco, f_com, f_civ, f_geo, f_rel, s_mat, s_eng, s_phy, s_che, s_bio, s_agri, s_ent, s_f_m, s_eco, s_com, s_civ, s_geo, s_rel, t_mat, t_eng, t_phy, t_che, t_bio, t_agri, t_ent, t_f_m, t_eco, t_com, t_civ, t_geo, t_rel, to_mat, to_eng, to_phy, to_che, to_bio, to_agri, to_ent, to_f_m, to_eco, to_com, to_civ, to_geo, to_rel, total_score, status) VALUES('$name', '$addmission_number', '$session', '$term', '$mat', '$eng', '$phy', '$che', '$bio', '$agri', '$ent', '$f_m', '$eco', '$com', '$civ', '$geo', '$rel', '$f_mat', '$f_eng', '$f_phy', '$f_che', '$f_bio', '$f_agri', '$f_ent', '$f_f_m', '$f_eco', '$f_com', '$f_civ', '$f_geo', '$f_rel', '$s_mat', '$s_eng', '$s_phy', '$s_che', '$s_bio', '$s_agri', '$s_ent', '$s_f_m', '$s_eco', '$s_com', '$s_civ', '$s_geo', '$s_rel', '$t_mat', '$t_eng', '$t_phy', '$t_che', '$t_bio', '$t_agri', '$t_ent', '$t_f_m', '$t_eco', '$t_com', '$t_civ', '$t_geo', '$t_rel', '$to_mat', '$to_eng', '$to_phy', '$to_che', '$to_bio', '$to_agri', '$to_ent', '$to_f_m', '$to_eco', '$to_com', '$to_civ', '$to_geo', '$to_rel', '$total_score', 'not approved') ";
