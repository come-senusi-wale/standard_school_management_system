<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($category == 'p_nur') {
            ...
            $query = "UPDATE $class_exam_table SET  mat = '$mat', eng = '$eng', v_r = '$v_r', q_r = '$q_r', cat = '$cat', she = '$she', ple = '$ple', r_s = '$r_s', hdw = '$hdw', com = '$com', sed = '$sed', mis = '$mis',  f_mat = '$f_mat', f_eng = '$f_eng', f_v_r = '$f_v_r', f_q_r = '$f_q_r', f_cat = '$f_cat', f_she = '$f_she', f_ple = '$f_ple', f_r_s = '$f_r_s', f_hdw = '$f_hdw', f_com = '$f_com', f_sed = '$f_sed', f_mis = '$f_mis',  s_mat = '$s_mat', s_eng = '$s_eng', s_v_r = '$s_v_r', s_q_r = '$s_q_r', s_cat = '$s_cat', s_she = '$s_she', s_ple = '$s_ple', s_r_s = '$s_r_s', s_hdw = '$s_hdw', s_com = '$s_com', s_sed = '$s_sed', s_mis = '$s_mis',  to_mat = '$to_mat', to_eng = '$to_eng', to_v_r = '$to_v_r', to_q_r = '$to_q_r', to_cat = '$to_cat', to_she = '$to_she', to_ple = '$to_ple', to_r_s = '$to_r_s', to_hdw = '$to_hdw', to_com = '$to_com', to_sed = '$to_sed', to_mis = '$to_mis', total_score = '$total_score'  WHERE addmission_num = '$addmission_number' AND session = '$session' AND term = '$term'";
            ...
            if ($query_run) {
                ...
                header("location: ../pupil_exam_edit_form.php?success=$success&term=$term&class=$class&ca=$ca&category=$category&session=$session&addmission_number=$addmission_number");
                ...
                header("location: ../pupil_exam_edit_form.php?fail=$fail&term=$term&class=$class&ca=$ca&category=$category&session=$session&addmission_number=$addmission_number");
            ...
            $query = "UPDATE $class_exam_table SET  mat = '$mat', eng = '$eng', v_r = '$v_r', q_r = '$q_r', cat = '$cat', she = '$she', ple = '$ple', r_s = '$r_s', hdw = '$hdw', com = '$com', sed = '$sed', mis = '$mis', caf = '$caf', f_mat = '$f_mat', f_eng = '$f_eng', f_v_r = '$f_v_r', f_q_r = '$f_q_r', f_cat = '$f_cat', f_she = '$f_she', f_ple = '$f_ple', f_r_s = '$f_r_s', f_hdw = '$f_hdw', f_com = '$f_com', f_sed = '$f_sed', f_mis = '$f_mis', f_caf = '$f_caf', s_mat = '$s_mat', s_eng = '$eng', s_v_r = '$s_v_r', s_q_r = '$s_q_r', s_cat = '$s_cat', s_she = '$s_she', s_ple = '$s_ple', s_r_s = '$s_r_s', s_hdw = '$s_hdw', s_com = '$s_com', s_sed = '$s_sed', s_mis = '$s_mis', s_caf = '$s_caf', to_mat = '$to_mat', to_eng = '$to_eng', to_v_r = '$to_v_r', to_q_r = '$to_q_r', to_cat = '$to_cat', to_she = '$to_she', to_ple = '$to_ple', to_r_s = '$to_r_s', to_hdw = '$to_hdw', to_com = '$to_com', to_sed = '$to_sed', to_mis = '$to_mis', to_caf = '$to_caf', total_score = '$total_score'  WHERE addmission_num = '$addmission_number' AND session = '$session' AND term = '$term'";
            ...
            $query = "UPDATE $class_exam_table SET  mat = '$mat', eng = '$eng', v_r = '$v_r', q_r = '$q_r', r_s = '$r_s', ldv = '$ldv', ple = '$ple', sos = '$sos', hdw = '$hdw', com = '$com', ccc = '$ccc', mis = '$mis', she = '$she', f_mat = '$f_mat', f_eng = '$f_eng', f_v_r = '$f_v_r', f_q_r = '$f_q_r', f_r_s = '$f_r_s', f_ldv = '$f_ldv', f_ple = '$f_ple', f_sos = '$f_sos', f_hdw = '$f_hdw', f_com = '$f_com', f_ccc = '$f_ccc', f_mis = '$f_mis', f_she = '$f_she', s_mat = '$s_mat', s_eng = '$s_eng', s_v_r = '$s_v_r', s_q_r = '$s_q_r', s_r_s = '$s_r_s', s_ldv = '$s_ldv', s_ple = '$s_ple', s_sos = '$s_sos', s_hdw = '$s_hdw', s_com = '$s_com', s_ccc = '$s_ccc', s_mis = '$s_mis', s_she = '$s_she', to_mat = '$to_mat', to_eng = '$to_eng', to_v_r = '$to_v_r', to_q_r = '$to_q_r', to_r_s = '$to_r_s', to_ldv = '$to_ldv', to_ple = '$to_ple', to_sos = '$to_sos', to_hdw = '$to_hdw', to_com = '$to_com', to_ccc = '$to_ccc', to_mis = '$to_mis', to_she = '$to_she', total_score = '$total_score'  WHERE addmission_num = '$addmission_number' AND session = '$session' AND term = '$term'";
            ...
            $query = "UPDATE $class_exam_table SET mat = '$mat', eng = '$eng', v_r = '$v_r', q_r = '$q_r', cca = '$cca', spc = '$spc', lit = '$lit', phe = '$phe', agri = '$agri', b_s = '$b_s', sos = '$sos', com = '$com', civ = '$civ', mis = '$mis', cco = '$cco', wrt = '$wrt', drw = '$drw', lan = '$lan', f_mat = '$f_mat', f_eng = '$f_eng', f_v_r = '$f_v_r', f_q_r = '$f_q_r', f_cca = '$f_cca', f_spc = '$f_spc', f_lit = '$f_lit', f_phe = '$f_phe', f_agri = '$f_agri', f_b_s = '$f_b_s', f_sos = '$f_sos', f_com = '$f_com', f_civ = '$f_civ', f_mis = '$f_mis', f_cco = '$f_cco', f_wrt = '$f_wrt', f_drw = '$f_drw', f_lan = '$f_lan', s_mat = '$s_mat', s_eng = '$s_eng', s_v_r = '$s_v_r', s_q_r = '$s_q_r', s_cca = '$s_cca', s_spc = '$s_spc', s_lit = '$s_lit', s_phe = '$s_phe', s_agri = '$s_agri', s_b_s = '$s_b_s', s_sos = '$s_sos', s_com = '$s_com', s_civ = '$s_civ', s_mis = '$s_mis', s_cco = '$s_cco', s_wrt = '$s_wrt', s_drw = '$s_drw', s_lan = '$s_lan', to_mat = '$to_mat', to_eng = '$to_eng', to_v_r = '$to_v_r', to_q_r = '$to_q_r', to_cca = '$to_cca', to_spc = '$to_spc', to_lit = '$to_lit', to_phe = '$to_phe', to_agri = '$to_agri', to_b_s = '$to_b_s', to_sos = '$to_sos', to_com = '$to_com', to_civ = '$to_civ', to_mis = '$to_mis', to_cco = '$to_cco', to_wrt = '$to_wrt', to_drw = '$to_drw', to_lan = '$to_lan',   total_score = '$total_score'  WHERE addmission_num = '$addmission_number' AND session = '$session' AND term = '$term'";
