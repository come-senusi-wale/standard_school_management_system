...
<head>
    ...
    <title>single pupils result form</title>
...
<body>
    ...
    <div id="form_container">
        ...
        <h2>single pupil result form</h2>
        ...
        <form action="single_pupil_class_result_details_view.php"  method="POST">
            ...
            <div class="input_container">
                ...
                <div class="two">
                    ...
                    <div class="form_input">
                        ...
                        <select name="category" id="category" class="class_category">
