<?php
    ...
    if (isset($_GET['fail'])) {
        ...
        $query_two = "SELECT * FROM $class_exam_table WHERE session = '$session' AND term = '$term' AND 	addmission_num = '$addmission_number'";
...
<head>
    ...
    <title>pupil exam edit form</title>
...
<body>
    ...
    <section id="reg_section">
        <div class="reg_header">
            <h2><?php echo $class.' '.$term.' term exam editing form' ?></h2>
            <p id="error" style="color: red;"><<?php echo $fail; ?>/p>
            ...
            <div id="container_body">
                ...
                <form action="action_php/pupil_exam_edit_form_action.php" method="POST" id="ca_form">
