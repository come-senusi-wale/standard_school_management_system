...
<head>
    ...
    <title>single student exam detail form</title>
...
<body>
    ...
    <div id="form_container">
        ...
        <h2>single student exam records detail form</h2>
        ...
        <form action="single_student_class_exam_detail_view.php"  method="POST">
