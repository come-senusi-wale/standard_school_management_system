...
<head>
    ...
    <title>pupils online exam status change form</title>
...
<body>
    ...
    <div id="form_container">
        ...
        <h2>pupils online exam status change form</h2>
        ...
        $(document).ready(function(){
            ...
            $('#submit').click(function(event){
                ...
                $.ajax({
                    ...
                    data: {action: 'pupils change online change exam status', id, exam_id, status, classe},
                    method: 'POST',
                    dataType: 'text',
                    beforeSend: function(){
