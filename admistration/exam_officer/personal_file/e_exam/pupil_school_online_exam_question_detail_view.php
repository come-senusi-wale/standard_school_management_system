...
<html lang="en">
    <head>
        ...
        <title>pupils school online exam question detail</title>
    ...
    <body>
        ...
        <div class="reg_header">
            <h2>pupils school online exam question detail</h2>
                        ...
                        if ($num < 1) {
                            ...
                            while ($row = mysqli_fetch_array($query_run)) {
                                ...
                                while ($row_two = mysqli_fetch_array($query_run_two)) {
                                    ...
                                    $edit = '<a href="pupil_school_online_exam_question_edit_editing_form.php?exam_id='.$exam_id.'&question_id='.$question_id.'&class='.$class.'" class="edit_btn"  data-id="'.$id_ques.'">edit</a>';
            ...
            $(document).on('click', '.delete_btn', function(event){
                ...
                if (confirm('are you sure want to delete this question')) {
                    ...
                    $.ajax({
                        ...
                        data: {action: 'pupils delete online exam question and option', id, exam_id, question_id, classe},
                        method: 'POST',
                        dataType: 'text',
                        beforeSend: function(){
