<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($session) || empty($term) || empty($class) || empty($exam_id)){
            ...
            header("location: pupil_class_online_exam_result_form.php?fail=$output");
            exit();
...
<html lang="en">
    <head>
        ...
        <title>pupil school online exam detail</title>
    ...
    <body>
                    ...
                    <?php
                        ...
                        if ($num < 1) {
                            ...
                            while ($row = mysqli_fetch_array($query_run)) {
                                ...
                                $print = '<a href="single_pupil_online_exam_result_print.php?term='.$term.'&exam_id='.$exam_id.'&session='.$session.'&class='.$class.'&addmission_num='.$addmission_num.'" class="edit_btn">print</a>';
        ...
        <div id="print">
            <a href="pupil_class_online_exam_result_print.php?term=<?php echo $term ?>&exam_id=<?php echo $exam_id ?>&session=<?php echo $session ?>&class=<?php echo $class ?>">print</a>
        </div>
    </section>
