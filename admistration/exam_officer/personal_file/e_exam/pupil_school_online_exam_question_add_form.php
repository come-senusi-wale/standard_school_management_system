...
<head>
    ...
    <title>pupils online exam question add</title>
...
<body>
    ...
    <div id="form_container">
        ...
        <h2>pupils online exam question <?php echo $exam_id ?></h2>
            ...
            $('#submit').click(function(event) {
                ...
                if (option_one_text == '' || option_two_text == '' || option_three_text == '' || option_four_text == '' || right_option == '' || question == '') {
                    ...
                    $.ajax({
                        ...
                        data: {action: 'pupil_school online exam question add', question, option_one_text, option_two_text, option_three_text, option_four_text, right_option, right_option_text, exam_id, classe, option_one_data, option_two_data, option_three_data, option_four_data},
                        method: 'POST',
                        dataType: 'text',
