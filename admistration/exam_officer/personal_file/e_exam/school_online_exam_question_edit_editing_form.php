...
<head>
    ...
    <title>student online exam question edit</title>
...
<body>
    ...
    <div id="form_container">
        ...
        <h2>student online exam question editing form <?php echo $question_id ?></h2>
            ...
            $('#submit').click(function(event) {
                ...
                if (option_one_text == '' || option_two_text == '' || option_three_text == '' || option_four_text == '' || right_option == '' || question == '') {
                    ...
                    $.ajax({
                        ...
                        data: {action: 'school online exam question editng', question, option_one_text, option_two_text, option_three_text, option_four_text, right_option, right_option_text, exam_id, classe, option_one_data, option_two_data, option_three_data, option_four_data, question_id},
                        method: 'POST',
                        dataType: 'text',
