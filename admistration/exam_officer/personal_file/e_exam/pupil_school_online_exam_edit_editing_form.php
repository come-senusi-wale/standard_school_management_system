<?php
    ...
    if (isset($_GET['id'])) {
        ...
        $query = "SELECT * FROM pupil_school_online_exam_creation_table WHERE id = '$id'";
...
<head>
    ...
    <title>pupils online exam editing form</title>
...
<body>
    ...
    <div id="form_container">
        ...
        <h2>pupils online exam editing form</h2>
            ...
            $('#submit').click(function(event) {
                ...
                if (id == '' || exam_id == '' || type == '' || mark == '' || duration == '' || total_question == '' ) {
                    ...
                    $.ajax({
                        ...
                        data: {action: 'pupil school online exam edit', id, exam_id, type, total_question, mark, duration},
                        method: 'POST',
                        dataType: 'text',
