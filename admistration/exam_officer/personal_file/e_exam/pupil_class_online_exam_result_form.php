...
<head>
    ...
    <title>pupils calss online exam result form</title>
...
<body>
    ...
    <div id="form_container">
        ...
        <h2>pupils class online exam/test result form</h2>
        ...
        <form action="pupil_class_online_exam_result_detail_view.php"  method="POST">
