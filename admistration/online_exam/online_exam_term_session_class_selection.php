...
<head>
    ...
    <title>online exam class verification</title>
    ...
    <div id="form_container">
        <div class="form_element">
            <form action="" id="form">
                ...
                <h2>student class verification</h2>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data.result == 'verified') {
                                ...
                                window.location.assign(`online_exam_selection.php?class=${classe}&term=${term}&session=${session}`);
                            }else{
