    ...
    <section id="exam_body">
        ...
        <section id="profile_body">
            ...
            <div id="submit_container">
                ...
                <div class="img">
                    <img src="../../image/student/<?php echo $_SESSION['image'] ?>" alt="">
                </div>
                ...
                <div id="info">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><?php echo $_SESSION['addmission_num'] ?></td>
                        </tr>
        ...
        <input type="hidden" name="" id="name" value="<?php echo $_SESSION['name'] ?>">
        ...
        $(document).ready(function(){
            ...
            function time() {
                ...
                if (timee < 0) {
                    ...
                    window.location.assign(`action_php/student_complete_online_exam_question_action.php?name=${name}`);
