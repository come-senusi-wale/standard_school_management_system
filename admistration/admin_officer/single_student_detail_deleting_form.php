...
<head>
    ...
    <title>single student editig form</title>
...
<body>
    ...
    <div id="form_container">
        <div class="form_element">
            <form action="single_student_detail_editing.php" method="POST" id="form">
                ...
                <h2>single student delete form</h2>
                ...
                // confirm('are you sure you want to delete this details');
                 ...
                 if (confirm('are you sure you want to delete this details')) {
                    ...
                    $.ajax({
                        ...
                        data: {action: 'delete single student detail', addmission_number: addmission_number},
                        method: 'POST',
                        dataType: 'text',
                        beforeSend: function(){
