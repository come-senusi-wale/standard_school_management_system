<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($session) || empty($term)) {
            ...
            header("location: student_attendance_creation_detail_form.php?result=$output");
            ...
            if (!preg_match($session_reg, $session)) {
                ...
                $query = "SELECT * FROM student_attendance_creation_table WHERE session = '$session' AND term = '$term'";
...
<html lang="en">
    ...
    <body>
        ...
        <div class="reg_header">
            <h2>student termly attendance details</h2>
                ...
                <table>
                    ...
                    <?php
                        ...
                        while ($row = mysqli_fetch_array($query_run)) {
                            ...
                            $edit = '<a href="student_attendance_edit_editing_form.php?id='.$id.'" class="edit_btn" id="edit'.$id.'" data-id="'.$id.'">edit</a>';
            ...
            $(document).on('click', '.delete_btn', function(event){
                ...
                if (confirm('are you sure want to delete this')) {
                    ...
                    $.ajax({
                        ...
                        data: {action: 'delete student attendance creation', id: id},
                        method: 'POST',
                        dataType: 'text',
                        beforeSend: function(){
