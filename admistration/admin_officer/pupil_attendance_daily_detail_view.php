<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($session) || empty($term) || empty($class) || empty($date)) {
            ...
            header("location: pupil_attendance_daily_detail_form.php?result=$output");
...
<head>
    ...
    <title>pupil daily attendance details</title>
        ...
        <div class="reg_body">
            ...
            <div class="page">
                ...
                <ul id="pages">
                    ...
                    <li><a data-id="prev" href="pupil_attendance_daily_detail_view.php?page=<?php echo $prev ?>&&date=<?php echo $date ?>&amp;session=<?php echo $session?>&amp;class=<?php echo $class?>&amp;term=<?php echo $term?>">prev</a></li>
                    <?php
                        for ($i=1; $i <= $total_page; $i++) { 
                    ?>
                            <li><a data-id="<?php echo $i ?>" href="pupil_attendance_daily_detail_view.php?page=<?php echo $i ?>&&date=<?php echo $date ?>&amp;session=<?php echo $session?>&amp;class=<?php echo $class?>&amp;term=<?php echo $term?>"><?php echo $i ?></a></li>
                    <?php
                        }
                    ?>
                    <li><a data-id="next" href="pupil_attendance_daily_detail_view.php?page=<?php echo $next ?>&&date=<?php echo $date ?>&amp;session=<?php echo $session?>&amp;class=<?php echo $class?>&amp;term=<?php echo $term?>">next</a></li>
                </ul>
            </div>
