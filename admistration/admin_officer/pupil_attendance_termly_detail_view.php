<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($session) || empty($term) || empty($class)) {
            ...
            header("location: pupil_attendance_termly_detail_form.php?result=$output");
...
<head>
    ...
    <title>pupil termly attendance</title>
...
<body>
    ...
    <section id="reg_section">
            <div class="reg_header">
                <h2><?php echo $class ?> pupil daily attendance details</h2>
            ...
            <div class="reg_body">
                            ...
                            if ($num > 0) {
                                ...
                                while ($row = mysqli_fetch_array($query_run)) {
                                    ...
                                    ?>
                                        ...
                                        <td><a href="pupil_attendance_termly_single_detail.php?addmission_num=<?php echo $addmission_num ?>&amp;session=<?php echo $session?>&amp;class=<?php echo $class?>&amp;term=<?php echo $term?>" class="edit_btn" id="edit" data-id="">view</a></td>
                                        </tr>
                ...
                <div class="page">
                    ...
                    <ul id="pages">
                        ...
                        <li><a data-id="prev" href="pupil_attendance_termly_detail_view.php?page=<?php echo $prev ?>&amp;session=<?php echo $session?>&amp;class=<?php echo $class?>&amp;term=<?php echo $term?>">prev</a></li>
                        <?php
                            for ($i=1; $i <= $total_page; $i++) { 
                        ?>
                                <li><a data-id="<?php echo $i ?>" href="pupil_attendance_termly_detail_view.php?page=<?php echo $i ?>&amp;session=<?php echo $session?>&amp;class=<?php echo $class?>&amp;term=<?php echo $term?>"><?php echo $i ?></a></li>
                        <?php
                            }
                        ?>
                        <li><a data-id="next" href="pupil_attendance_termly_detail_view.php?page=<?php echo $next ?>&amp;session=<?php echo $session?>&amp;class=<?php echo $class?>&amp;term=<?php echo $term?>">next</a></li>
                    </ul>
                </div>
