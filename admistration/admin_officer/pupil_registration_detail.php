<?php
    ...
    //if (isset($_POST['submit'])) {
        ...
        $query_two = "SELECT count(*) AS total FROM pupil_registration_table WHERE session = '$academic_session' ORDER BY current_class";
        ...
        //$academic_session = mysqli_real_escape_string($conn, $_POST['session']);
        // select student data................................
        $query = "SELECT * FROM pupil_registration_table WHERE session = '$academic_session' ORDER BY current_class LIMIT $start_from, $limit ";
...
<body>
        ...
        <div class="reg_body">
                ...
                <table>
                    ...
                    <?php
                                ...
                                while ($row = mysqli_fetch_array($query_run)) {
                                    ...
                                    $view ='<a href="pupil_detail_view.php?id='.$id.'" class="view_btn" id="view'.$id.'" data-id="'.$id.'">view</a>';
                                    $edit = '<a href="pupil_details_editing.php?id='.$id.'" class="edit_btn" id="edit'.$id.'" data-id="'.$id.'">edit</a>';
            ...
            <div class="page">
                ...
                <ul id="pages">
                    ...
                    <li><a data-id="prev" href="pupil_registration_detail.php?page=<?php echo $prev ?>&amp;session=<?php echo $academic_session?>">prev</a></li>
                    <?php
                        for ($i=1; $i <= $total_page; $i++) { 
                    ?>
                            <li><a data-id="<?php echo $i ?>" href="pupil_registration_detail.php?page=<?php echo $i ?>&amp;session=<?php echo $academic_session?>"><?php echo $i ?></a></li>
                    <?php
                        }
                    ?>
                    <li><a data-id="next" href="pupil_registration_detail.php?page=<?php echo $next ?>&amp;session=<?php echo $academic_session?>">next</a></li>
                </ul>
            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            // deleting pupil detail with ajax....................................
            ...
            $(document).on('click', '.delete_btn', function(event){
                ...
                if (confirm('are you sure you want to delete this detail')) {
                    ...
                    $.ajax({
                        ...
                        data: {action: 'deleting pupil registration detail', id: id},
                        method: 'POST',
                        dataType: 'text', 
