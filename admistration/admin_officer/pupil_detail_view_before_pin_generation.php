...
if (isset($_POST['submit'])) {
    ...
    if (empty($addmission_num)) {
        ...
        header("location: pupil_pin_generation_form.php?result=$result");
    }else {
        
        $query = "SELECT * FROM pupil_registration_table WHERE addmission_num = '$addmission_num'";
    ...
    $(document).ready(function(){
        ...
        $('#submit').click(function(event){
            ...
            $.ajax({
                ...
                url: 'action_php/pupil_pin_action.php',
                data: {action: 'come oo', addmission_num},
                method: 'POST',
                dataType: 'text',
