...
<head>
    ...
    <title>single pupil class insertion</title>
...
<body>
    ...
    <div id="form_container">
        ...
        <h2>single pupil class entrance</h2>
    ...
    $(document).ready(function(){
        ...
        $('#submit').click(function(event){
            ...
            $.ajax({
                ...
                data: {action: 'insert single pupil to class', addmission_number: addmission_number, classes: classes, session: session, term: term },
                method: 'POST',
                dataType: 'text',
                beforeSend: function(){
