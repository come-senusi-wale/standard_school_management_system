...
<html lang="en">
    <head>
        ...
        <title>pupil attendance creation form</title>
    ...
    <body>
        ...
        <div id="form_container">
            ...
            <h2>pupils formaster/formistress email resend form</h2>
            ...
            <form action="action_php/pupil_resend_formaster_email_form_action.php"  method="POST">
                ...
                <div class="submit">
                    <input type="submit" name="submit" id="submit" value="resend">
                </div>
