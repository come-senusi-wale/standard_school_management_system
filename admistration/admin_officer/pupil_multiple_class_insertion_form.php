...
<body>
    ...
    <div id="form_container">
        ...
        <h2>multiple pupils class entrance</h2>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#submit').click(function(event){
                ...
                if (prev_session == '' || prev_class == '' || next_session == '' || next_class == '' || term == '') {

                    $('#fail').text('please fill all the inputs');
                    ...
                    $.ajax({
                        ...
                        data: {action: 'insert multiple pupil class', prev_session: prev_session, prev_class: prev_class, next_session: next_session, next_class: next_class, term: term},
                        method: 'POST',
                        dataType: 'text',
                        beforeSend: function(){
