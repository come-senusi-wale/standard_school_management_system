<?php
    ...
    $query_two = "SELECT * FROM pupil_attendance_creation_table WHERE id = '$id'";
...
<html lang="en">
    <head>
        ...
        <title>pupil attendance editing form</title>
    ...
    <body>
        ...
        <div id="form_container">
            ...
            <h2>pupil attendance editing form</h2>
            ...
            <form action="action_php/pupil_attendance_edit_form_action.php"  method="POST">
