...
<body>
    ...
    <div id="form_container">
        ...
        <h2>pupil attendance creation form</h2>
        ...
        <form action="action_php/pupil_attendance_creation_form_action.php"  method="POST">
        ...
        <div id="resend_email">
            <a href="pupil_resend_formaster_email_form.php">resend email</a>
        </div>
