...
<head>
    ...
    <title>pupil image editing form</title>
...
<body>
    ...
    <div id="form_container">
        <div class="form_element">
            <form action="action_php/pupil_image_editing_action.php" method="POST" id="form" enctype="multipart/form-data">
                ...
                <h2>pupil image updating form</h2>
