...
<html lang="en">
    <head>
        ...
        <title>pupil class details</title>
    ...
    <body>
        ...
        <section id="reg_section">
            ...
            <div class="reg_body">
                ...
                <div class="page">
                    <ul id="pages">
                        <li><a href="print_pupil_class_detail.php?session=<?php echo $session?>&amp;term=<?php echo $term ?>&amp;class=<?php echo $class ?>" style="background-color: #5fcf80; color: #fff;">print</a></li>
                    </ul>
                    
                    <ul id="pages">
                        
                        <li><a data-id="prev" href="pupil_class_detail_view.php?page=<?php echo $prev ?>&amp;session=<?php echo $session?>&amp;term=<?php echo $term ?>&amp;class=<?php echo $class ?>">prev</a></li>
                        <?php
                            for ($i=1; $i <= $total_page; $i++) { 
                        ?>
                                <li><a data-id="<?php echo $i ?>" href="pupil_class_detail_view.php?page=<?php echo $i ?>&amp;session=<?php echo $session?>&amp;term=<?php echo $term ?>&amp;class=<?php echo $class ?>"><?php echo $i ?></a></li>
                        <?php
                            }
                        ?>
                        <li><a data-id="next" href="pupil_class_detail_view.php?page=<?php echo $next ?>&amp;session=<?php echo $session?>&amp;term=<?php echo $term ?>&amp;class=<?php echo $class ?>">next</a></li>
                    </ul>
                </div>
                ...
                $(document).on('click', '.delete_btn', function(event){
                    ...
                    if (confirm('are sure you want to delete')) {
                        ...
                        $.ajax({
                            ...
                            data: {action: 'delete pupil from class', id: id, term: term, classes: classes},
                            method: 'POST',
                            dataType: 'text',
