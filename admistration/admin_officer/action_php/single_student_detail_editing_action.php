<?php
    ...
    //if (isset($_POST['submit'])) {
        ...
        if (!preg_match($f_reg, $f_phone)) {
            ...
            header("location: ../single_student_detail_editing.php?result=$out&&addmission_number=$addmission_number");
        }else{
                ...
                if (!preg_match($session_reg, $academic_session)) {
                    ...
                    if ($query_run) {
                        ...
                        header("location: ../single_student_detail_editing.php?correct=$out&&addmission_number=$addmission_number");
                    }else{
