...
<html lang="en">
    ...
    <body>
        ...
        <div id="form_container">
            ...
            <h2> pupils formaster/formistress email verification</h2>
            ...
            $('#submit').click(function(event) {
                ...
                if ($('#email_code').val() != '') {
                    ...
                    $.ajax({
                        ...
                        data: {action: 'pupil formaster/formistress email verify', email_code: email_code, email_token: email_token},
                        method: 'POST',
                        dataType: 'text',
