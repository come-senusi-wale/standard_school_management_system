<?php
    ...
    //if (isset($_POST['submit'])) {
        ...
        if ($num < 1) {
            ...
            header("location: single_pupil_detail_editing_form.php?result=$out");
        }else{
...
<body>
    ...
    <div id="form_container">
        ...
        <h2>single pupil editing form</h2>
    
        <form action="action_php/single_pupil_detail_editing_action.php" method="POST" id="form">
