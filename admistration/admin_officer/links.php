    ...
    <div id="links_container">
        ...
        <div id="btn_group">
            ...
            <div class="btn-group">
                ...
                <a class="dropdown-item" href="student_pin_generation_form.php">pin generation</a>
                </div>
            </div>
            ...
            <div class="btn-group">
                ...
                <a class="dropdown-item" href="student_attendance_termly_detail_form.php">termly daitail</a>
                <a class="dropdown-item" href="student_attendance_daily_detail_form.php">daily detail</a>
                </div>
            </div>
