<?php
    ...
    if (isset($_GET['email'])) {
        ...
        $query_two = "SELECT * FROM staff_attendance_table WHERE email = '$email' AND session = '$session' AND term = '$term'";
...
<html lang="en">
    <head>
        ...
        <title>staff termly attendance details</title>
        
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
        <link rel="stylesheet" href="css/links_css.css">
        <link rel="stylesheet" href="css/staff_attendance_termly_single_detail_css.css">
                ...
                <div id="table_head">
                    <table>
                        <tr>
                            ...
                            <td class="quantity"><?php echo $surname.'  '.$first_name.'  '.$other_name; ?></td>
                        </tr>
                        <tr>
                            <td class="name">email</td>
                            <td class="quantity"><?php echo $email ?></td>
                        </tr>
                        <tr>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $query = "SELECT * FROM staff_attendance_table WHERE email = '$email' AND session = '$session' AND term = '$term'";
