<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($session) || empty($term) || empty($class) || empty($subject) || empty($ca)) {
            ...
            header("location: pupil_subject_ca_performance_form.php?fail=$fail");
            exit();
                ...
                while ($row_three = mysqli_fetch_array($query_run_three)) {
                    ...
                    if ($course_score_two == 1) {
                       ...
                       $nine_score++;
                        ...
                        $zero_score++;
                    } elseif ($course_score_two == 10) {
                        $ten_score++;
                    } elseif ($course_score_two == 11) {
                        $ele_score++;                                  
                    } elseif ($course_score_two == 12) {
                        $twe_score_score++;
                    } elseif ($course_score_two ==13) {
                        $thir_score_score++;
                    } elseif ($course_score_two == 14) {
                        $fourt_score_score++;
                    } elseif ($course_score_two == 15) {
                        $fif_score_score++;
                    } elseif ($course_score_two == 16) {
                        $sit_score_score++;
                    } elseif ($course_score_two == 17) {
                        $sevent_score_score++;
                    } elseif ($course_score_two == 18) {
                        $eighten_score_score++;
                ...
                $(document).ready(function(){
                        ...
                        function drawChart() {
                            var data = google.visualization.arrayToDataTable([
                                ...
                                ["11", <?php echo $ele_score ?>, "tomato"],
                                ["12", <?php echo $twe_score ?>, "orange"],
                                ["13", <?php echo $thir_score ?>, "gold"],
                                ["14", <?php echo $fourt_score ?>, "color: #e5e4e2"],
                                ["15", <?php echo $fif_score ?>, "color: yellow"],
                                ["16", <?php echo $sit_score ?>, "color: silver"],
                                ["17", <?php echo $sevent_score ?>, "color: chartreuse"],
                                ["18", <?php echo $eighten_score ?>, "color: purple"],
                                ["19", <?php echo $ninet_score ?>, "color: green"],
                                ["20", <?php echo $twety_score ?>, "color: blue"]
                            ]);
