...
<head>
    ...
    <title>pupils general exam performance</title>
...
<body>
    ...
    <div id="form_container">
        ...
        <h2>pupils general exam performance form</h2>
        ...
        <form action="pupil_general_exam_performance_details_view.php"  method="POST">
