...
<head>
    ...
    <title>pupils general result performance</title>
...
<body>
    ...
    <div id="form_container">
        ...
        <h2>pupils general result performance form</h2>
        ...
        <form action="pupil_general_result_performance_deatils_view.php"  method="POST">
