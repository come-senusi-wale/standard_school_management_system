        ...
        <div class="reg_body">
            ...
            <div class="page">
                ...
                <ul id="pages">
                    ...
                    <li><a data-id="prev" href="pupil_attendance_daily_detail_view.php?page=<?php echo $prev ?>&&date=<?php echo $date ?>">prev</a></li>
                    <?php
                        for ($i=1; $i <= $total_page; $i++) { 
                    ?>
                            <li><a data-id="<?php echo $i ?>" href="pupil_attendance_daily_detail_view.php?page=<?php echo $i ?>&&date=<?php echo $date ?>"><?php echo $i ?></a></li>
                    <?php
                        }
                    ?>
                    <li><a data-id="next" href="pupil_attendance_daily_detail_view.php?page=<?php echo $next ?>&&date=<?php echo $date ?>">next</a></li>
                </ul>
            </div>
