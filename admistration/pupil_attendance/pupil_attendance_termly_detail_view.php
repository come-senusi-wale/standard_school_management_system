            ...
            <div class="reg_body">
                            ...
                            if ($num > 0) {
                                ...
                                while ($row = mysqli_fetch_array($query_run)) {
                                    ...
                                    ?>
                                        ...
                                        <td><a href="pupil_attendance_termly_single_detail.php?addmission_num=<?php echo $addmission_num ?>" class="edit_btn" id="edit" data-id="">view</a></td>
                                        </tr>
                ...
                <div class="page">
                    ...
                    <ul id="pages">
                        ...
                        <li><a data-id="prev" href="pupil_attendance_termly_detail_view.php?page=<?php echo $prev ?>">prev</a></li>
                        <?php
                            for ($i=1; $i <= $total_page; $i++) { 
                        ?>
                                <li><a data-id="<?php echo $i ?>" href="pupil_attendance_termly_detail_view.php?page=<?php echo $i ?>"><?php echo $i ?></a></li>
                        <?php
                            }
                        ?>
                        <li><a data-id="next" href="pupil_attendance_termly_detail_view.php?page=<?php echo $next ?>">next</a></li>
                    </ul>
                </div>
