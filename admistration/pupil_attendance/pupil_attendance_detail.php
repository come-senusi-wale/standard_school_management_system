...
<head>
    ...
    <title>pupils attendance detail</title>
...
<body>
    ...
    <section id="reg_section">
            <div class="reg_header">
                <h2><?php echo $class ?> pupil  attendance details</h2>
            ...
            <div class="reg_body">
                ...
                <div class="page">
                    ...
                    <ul id="pages">
                        ...
                        <li><a data-id="prev" href="pupil_attendance_detail.php?page=<?php echo $prev ?>">prev</a></li>
                        <?php
                            for ($i=1; $i <= $total_page; $i++) { 
                        ?>
                                <li><a data-id="<?php echo $i ?>" href="pupil_attendance_detail.php?page=<?php echo $i ?>"><?php echo $i ?></a></li>
                        <?php
                            }
                        ?>
                        <li><a data-id="next" href="pupil_attendance_detail.php?page=<?php echo $next ?>">next</a></li>
                    </ul>
                </div>
